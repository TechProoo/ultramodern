import { Equipment, Part, Ticket, User } from './types';

// Seed data for the in-memory store — the same records the frontend shipped
// with, so swapping the client to the API is invisible to users.
